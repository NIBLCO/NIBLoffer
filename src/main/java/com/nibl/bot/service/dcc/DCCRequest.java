...
public class DCCRequest extends Service {
    ...
    public void executeTask() {
        ...
        try {
            ...
            dccTransfer = this.getDCCUser().getUser().send().dccFileAndTransfer(botFile.getPath().toFile());

            while (!dccTransfer.isFinished()) {
        ...
        } catch (DccException | InterruptedException | IOException e) {
